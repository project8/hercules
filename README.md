...
You can find example scripts in [configuration](./examples). Hercules scripts work in a desktop environment as well as on the grace cluster without requiring any modifications. 
